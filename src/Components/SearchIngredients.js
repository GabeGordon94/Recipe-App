...
class SearchIngredients extends React.Component {
    ...
    async getRecipesFromAPI() {
        ...
        fetch(`https://api.spoonacular.com/recipes/findByIngredients?apiKey=a3a214ea83184a19990692c16b8bfc42&ingredients=${this.state.ingredientsList}&ranking=1&ignorePantry=true&limitLicense=true`);
